...
FullTMSequencial::FullTMSequencial(){}
FullTMSequencial::FullTMSequencial(double fps, Mat mainImage, Point center, Point size, double windowProp, bool debug, bool adaptable){
...
void FullTMSequencial::process(Mat frame)
{
	...
	sLeftUp = minLoc + minWindow;
    sridown = minLoc + minWindow + size;
...
Point FullTMSequencial::mymatchTemplate(){
